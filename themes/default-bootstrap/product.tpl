...
<div itemscope itemtype="http://schema.org/Product">
	<div class="primary_block row">
            	<h1 class="st-title1" itemprop="name"><span>{$product->name|escape:'html':'UTF-8'}</span></h1>
		...
		<div class="pb-right-column">
                    {if isset($features) && $features}
                            ...
                            <section class="page-product-box">
                                    <h3 class="page-product-heading">{l s='Caractéristiques'}</h3>
				...
				<div class="box-info-product">
					<div class="content_prices clearfix">
						{if $product->show_price && !isset($restricted_country_mode) && !$PS_CATALOG_MODE}
							<!-- prices -->
							<div>
                                                            <div class="price-box {if ($product->specificPrice || $product->specificPrice.reduction)} block-drop-price{/if}">
                                                                {/strip}
                                                                    <span id="old_price"{if (!$product->specificPrice || !$product->specificPrice.reduction) && $group_reduction == 0} class="hidden"{/if}>{strip}
                                                                            ...
                                                                            {/if}
                                                                    {/strip}</span>
                                                                    <span class="our_price_display" itemprop="offers" itemscope itemtype="http://schema.org/Offer">{strip}
